...
const { Cookie } = require('tough-cookie-no-native')
// Maybe on future const isUrl = require('is-url')
...
class Instagram {
  ...
  // TODO! https://github.com/jlobos/instagram-web-api/issues/23
  async getHome() {
    return this.request('/?__a=1').then(data => data.graphql.user)
  }

  // TODO! async getUserByUsername({ username }) {
  //   return this.request({
  //     uri: `/${username}/?__a=1`,
  //     headers: {
  ...
  // TODO! async getPhotosByUsername({ username, first, after }) {
  //   const user = await this.getUserByUsername({ username })
  //   return this.getUserIdPhotos({ id: user.id, first, after })
  // }

  // TODO! async getStoryItemsByUsername({ username }) {
  //   const user = await this.getUserByUsername({ username })
  ...
  // TODO! async changeProfilePhoto({ photo }) {
  ...
  // TODO! async uploadStory({ photo, caption = '' }) {
  ...
  // TODO! async uploadPhoto({ photo, caption = '' }) {
  //   return this._uploadPhoto({ photo }).then(({ upload_id }) =>
